...
#
# teeensy-te8648-2-nrf52811.sh (also known as super simple sample code)
# this code for TE8648-2 will make the RX LED twinkle once after reset
#
...
# Taiyo Yuden TE8648-2 contains EYSNSNZWW (nRF52811 with a Cortex-M4)
ARCH=armv7e-m
...
output_asm $1 | ${CROSS_COMPILE}as -mlittle-endian -o "${t0}"
...
# example using Segger J-Link Ultra connected to TE8648-2
...
# resume
#
# (this will program the above software, resulting in the LED blinking once)
