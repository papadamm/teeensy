...
_start:
  ...
  /* initialize GPIO11 as output for WS2812B-2020 power supply */
  movs r0, #5
  ldr r5, =(0x4001405c + 0x0000) /* GPIO11_CTRL (normal alias) */
  str r0, [r5]

  /* set drive strength to maximum */
  movs r0, #0x30
  ldr r5, =(0x4001c030 + 0x0000) /* PADS_BANK0_BASE:GPIO11 (normal alias) */
  str r0, [r5]
  ...
  /* initialize GPIO12 as output for WS2812B-2020 control */
  movs r0, #5
  ldr r5, =(0x40014064 + 0x0000) /* GPIO12_CTRL (normal alias) */
  str r0, [r5]
...
loop2:
  ...
  ldr r2, =545  /* duration of a 300 us reset pulse */ 
dly:
  subs r2, #1
  bne dly
...
# (press SW1 /RESET to force a reset which turns on the LED)
