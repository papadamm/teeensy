...
#
# teeensy-genmai-r7s72100.sh (super simple sample code)
# this code for "Genmai" turns on LED1 and LED2 connected to P4_10 and P4_11
#
...
_start:
  /* configure P4.10 and P4.11 as outputs in low state */

  movs r0, #0x0c000000
  ldr r5, =0xfcfe3110 /* PSR4 (32-bit) */
  str r0, [r5]

  ldr r0, =0xf3ff
  ldr r5, =0xfcfe3310 /* PM4 (16-bit) */
  strh r0, [r5]
...
# example using Segger J-Link LITE connected to 20-pin JTAG port J22
