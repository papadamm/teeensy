...
# nRF52-DK (nRF52832 with a Cortex-M4)
ARCH=armv7e-m
...
_start:
  /* setup P0.17 as output but before that set the GPIO value to high */
  /* then pull the GPIO low to enable the LED */
	
  movs r0, #0x20000 /* 1 << 17 (P0.17) */
  ldr r5, =0x50000508 /* nRF52832 GPIO OUTSET */
  str r0, [r5] /* this makes sure the LED remains off */

  movs r0, #0x03
  ldr r5, =0x50000744 /* nRF52832 GPIO PIN_CNF[17] (P0.017) */
