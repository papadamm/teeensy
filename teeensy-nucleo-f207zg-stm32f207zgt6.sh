...
#
# teeensy-nucleo-f207zg-stm32f207zgt6.sh (super simple sample code)
# this code for "STM32F207 Nucleo-144" turns on the LD2 LED via GPIO PB7
#
...
# makes use of a stm32f207zgt6 (with a Cortex-M3)
ARCH=armv7-m
...
_start:
  ...
  /* configure GPIOB_MODER, clear/set PB7 using GPIOB_BSRR */

  ldr r0, =0x00000002 /* GPIOBEN = 1 */
  ldr r5, =0x40023830 /* RCC_AHB1ENR */
  str r0, [r5]

  ldr r0, =0x00800000 /* turn off PB7 LED by configuring GPIO low */
  ldr r5, =0x40020418 /* GPIOB_BSRR */
  str r0, [r5]

  ldr r0, =0x00004280 /* MODER14[1:0] = General purpose output mode */
  ldr r5, =0x40020400 /* GPIOB_MODER */
  str r0, [r5]

  ldr r0, =0x0080     /* turn on the LED by configuring GPIO high */
  ldr r5, =0x40020418 /* GPIOB_BSRR */
  str r0, [r5]
