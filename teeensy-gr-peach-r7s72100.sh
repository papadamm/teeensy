...
#
# teeensy-gr-peach-r7s72100.sh (super simple sample code)
# this code for "GR-PEACH" turns on LED2 connected to P6_12
#
...
_start:
  /* configure P6.12 as output in high state */

  ldr r0, =0x10001000
  ldr r5, =0xfcfe3118 /* PSR6 (32-bit) */
  str r0, [r5]

  ldr r0, =0xefff
  ldr r5, =0xfcfe3318 /* PM6 (16-bit) */
  strh r0, [r5]
...
# example using Segger J-Link LITE connected to mini 10-pin JTAG port
